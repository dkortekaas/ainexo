import { ContactInfo as ContactInfoType, SocialLink } from "@/types/types";
          ...
          <div className="flex gap-4">
            {socialLinks.map((social, index) => (
              <a
                ...
                className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-blue-100 dark:hover:bg-blue-900/30 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 flex items-center justify-center transition-colors"
